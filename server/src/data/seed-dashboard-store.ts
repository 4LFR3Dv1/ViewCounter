...
function buildOldSnapshots(accountId: string, totals: number[]): PersistedMetricSnapshot[] {
...
const events: PersistedActivityEvent[] = [
  {
    id: "evt-instagram-1",
...
const cases: PersistedCaseStudy[] = [
  {
    id: "case-1",
    platformSlug: "instagram",
    title: "Produto Tech",
...
export function createSeedDashboardStore(): DashboardStore {
