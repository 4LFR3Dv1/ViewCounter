import { buildTikTokStartPayload, getTikTokFrontendAppUrl, handleTikTokOAuthCallback, } from "../services/tiktok-auth-service";
import { buildYouTubeStartPayload, getFrontendAppUrl, handleYouTubeOAuthCallback, } from "../services/youtube-auth-service";
...
function buildRedirectUrl(returnTo, searchParams, baseUrl = getFrontendAppUrl()) {
...
export async function registerAuthRoutes(app) {
    app.get("/auth/youtube/start", async (request, reply) => {
    ...
    app.get("/auth/youtube/callback", async (request, reply) => {
        ...
        if (request.query.error) {
            return reply.redirect(buildRedirectUrl(returnTo, {
                provider: "youtube",
                status: "error",
    ...
    app.get("/auth/tiktok/start", async (request, reply) => {
